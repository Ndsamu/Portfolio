...
\begin{DoxyCompactList}\small\item\em \hyperlink{classLight}{Light} sensor used by robots in order to detect presence of lights. \end{DoxyCompactList}\end{DoxyCompactItemize}
