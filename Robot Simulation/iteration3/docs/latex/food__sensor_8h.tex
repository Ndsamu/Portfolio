...
\begin{DoxyCompactList}\small\item\em \hyperlink{classFood}{Food} sensor used by robots in order to detect presence of food. \end{DoxyCompactList}\end{DoxyCompactItemize}
