 ...
 */
  ...
  /**
   * @brief Getter method which returns heading.
   */
 ...
 private:
  // Radius of an arena entity.
  double radius_{DEFAULT_RADIUS};
  // Pose which determines the position and heading of an entity.
  Pose pose_;
  // Color of entity.
  RgbColor color_;
  // Type of entity.
  ...
  // Entity's ID.
  int id_{-1};
  // Determines mobility of an entity.
